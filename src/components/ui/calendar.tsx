    ...
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          ...
          props.mode === "range"
            ? "[&:has([aria-selected])]:bg-teal-100 [&:has(>.day-range-end)]:rounded-r-md [&:has(>.day-range-start)]:rounded-l-md first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md"
